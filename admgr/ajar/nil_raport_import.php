...
if ($_POST['btnBTL'])
	...
	//re-direct
	$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&jnskd=$jnskd&smtkd=$smtkd";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnIMx'])
	...
	if (empty($filex_namex2))
		...
		$ke = "nil_raport.php?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&smtkd=$smtkd&jnskd=$jnskd&s=import";
		pekem($pesan,$ke);
		exit();
		}
	else
