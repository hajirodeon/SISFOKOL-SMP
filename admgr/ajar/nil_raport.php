...
if ($_POST['btnSMP'])
	...
	for($k=1;$k<=$limit;$k++)
		...
		if ($tgk != 0)
			...
			{
			//insert
			mysql_query("INSERT INTO siswa_rangking(kd, kd_tapel, kd_kelas, ".
...
if ($_POST['btnIM2'])
	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".xls")
			...
			//re-direct
			$ke = "nil_raport_import.php?tapelkd=$tapelkd&kelkd=$kelkd&smtkd=$smtkd&progkd=$progkd&jnskd=$jnskd&filex_namex2=$filex_namex2";
			xloc($ke);
			exit();
			}
		else
