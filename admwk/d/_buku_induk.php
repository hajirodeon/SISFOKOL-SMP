...
$sheet->setCellValue('B25', 'C. Jurusan');
...
$sheet->setCellValue('AB3', 'SMA');
$sheet->setCellValue('AE3', ': '.$sek_nama.'');
$sheet->mergeCells('AE3:AH3');

$sheet->setCellValue('AB4', 'Jurusan');
