...
//data mapel
$qpel31 = mysql_query("SELECT DISTINCT(m_prog_pddkn.kd) AS pelkd ".
						"FROM m_prog_pddkn, m_prog_pddkn_kelas  ".
						"WHERE m_prog_pddkn.kd = m_prog_pddkn_kelas.kd_prog_pddkn ".
						"AND m_prog_pddkn.kd_jenis = '$ku_kd' ".
						"AND m_prog_pddkn_kelas.kd_tapel = '$tapelkd'".
...
//data mapel
$qpel32 = mysql_query("SELECT DISTINCT(m_prog_pddkn.kd) AS pelkd ".
						"FROM m_prog_pddkn, m_prog_pddkn_kelas  ".
						"WHERE m_prog_pddkn.kd = m_prog_pddkn_kelas.kd_prog_pddkn ".
						"AND m_prog_pddkn.kd_jenis = '$ku_kd' ".
						"AND m_prog_pddkn_kelas.kd_tapel = '$tapelkd'".
...
//data mapel
$qpel33 = mysql_query("SELECT DISTINCT(m_prog_pddkn.kd) AS pelkd ".
						"FROM m_prog_pddkn, m_prog_pddkn_kelas  ".
						"WHERE m_prog_pddkn.kd = m_prog_pddkn_kelas.kd_prog_pddkn ".
						"AND m_prog_pddkn.kd_jenis = '$ku_kd' ".
						"AND m_prog_pddkn_kelas.kd_tapel = '$tapelkd'".
...
$qpel32 = mysql_query("SELECT DISTINCT(m_prog_pddkn.kd) AS pelkd ".
						...
						"AND m_prog_pddkn_kelas.kd_tapel = '$tapelkd' ".
						"AND m_prog_pddkn_kelas.kd_kelas = '$kelkd' ".
//						"AND m_prog_pddkn.prog_pddkn <> '' ".
						"ORDER BY round(m_prog_pddkn.no) ASC, ".
						"round(m_prog_pddkn.no_sub) ASC");
$rpel32 = mysql_fetch_assoc($qpel31);
$tpel32 = mysql_num_rows($qpel32);
...
//baris ke
$kkx = 8 + (3 * ($tpel + $tpel2 + $tpel3 + $tpel31 + $tpel32)) + 2;
...
//naik ato lulus, ///////////////////////////////////////////////
//posisi
$posisi33 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel31 + $tpel32 + $tpel33 + $tpel4)) + $tkuti + 32 + $tabs;
...
//jika kelulusan
	...
	$posisi34 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel31 + $tpel32 + $tpel33 + $tpel4)) + $tkuti + 32 + $tabs + 1;
	$sheet->setCellValue('C'.$posisi34.'', 'Mengetahui');
	
	$posisi34 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel31 + $tpel32 + $tpel33 + $tpel4)) + $tkuti + 32 + $tabs + 2;
	...
	$posisi34 = (3 * ($tpel + $tpel2 + $tpel3 + $tpel31 + $tpel32 + $tpel33 + $tpel4)) + $tkuti + 32 + $tabs + 6;
