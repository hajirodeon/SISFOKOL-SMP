...
$ke = "$filenya?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&swkd=$swkd&skkd=$skkd&progkd=$progkd&page=$page";
...
if (empty($smtkd))
	...
	if ($ku_no == "1")
		{		
		echo '<p>
		[<a href="raport_xls.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smtkd='.$smtkd.'&swkd='.$swkd.'&skkd='.$skkd.'" target="_blank" title="Lihat Raport..."><img src="'.$sumber.'/img/xls.gif" width="16" height="16" border="0"></a>]
		</p>';
		}
