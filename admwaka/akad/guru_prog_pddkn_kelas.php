...
$s = nosql($_REQUEST['s']);
$ke = "$filenya?tapelkd=$tapelkd&singkatan=$singkatan&kelkd=$kelkd&jnskd=$jnskd";
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&singkatan='.$singkatan.'&kelkd='.$btkd.'">'.$btkelas.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&singkatan='.$singkatan.'&kelkd='.$kelkd.'&jnskd='.$jn_kd.'">'.$jn_jns.'</option>';
	}
