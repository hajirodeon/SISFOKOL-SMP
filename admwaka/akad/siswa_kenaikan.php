...
$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&skkd=$skkd&swkd=$swkd";
	...
	if (empty($tpfkd))
		...
		for ($i=1;$i<=$limit;$i++)
			...
			if ($tcc3 != 0)
				...
				//insert
				mysql_query("INSERT INTO siswa_kelas(kd, kd_siswa, kd_tapel, kd_kelas) VALUES ".
...
if ($_POST['btnSMP7'])
	...
	if (empty($lulus))
		...
		$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&smtkd=$smtkd&skkd=$skkd&swkd=$swkd";
		pekem($pesan,$ke);
		exit();
		}
	}
