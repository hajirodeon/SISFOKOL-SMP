...
if ($_POST['btnSMP'])
	...
	//D. KETERANGAN PENDIDIKAN /////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$alamat_sekolah = cegah($_POST['alamat_sekolah']);
		$no_sttb = nosql($_POST['no_sttb']);
		$no_skhun = nosql($_POST['no_skhun']);
		...
		if ($s == "edit")
			...
			//nek blm ada
				...
				{
				//insert
				mysql_query("INSERT INTO m_siswa_pendidikan(kd, kd_siswa, alamat_sekolah, lulusan, ".
								"tgl_sttb, no_sttb, skhun_tgl, skhun_nomor, lama) VALUES ".
								"('$x', '$swkd', '$alamat_sekolah', '$lulusan', ".
...
if (empty($tapelkd))
	...
	if (($s == "baru") OR ($s == "edit"))
		...
		if ($a == "d")
			...
			<td width="10">: </td>
			<td>
			<input name="lulusan" type="text" value="'.$y_lulusan.'" size="30">
			</td>
			</tr>
			...
			<td width="10">: </td>
			<td>
			<input name="alamat_sekolah" type="text" value="'.$y_alamat_sekolah.'" size="50">
			</td>
			</tr>
			...
			echo '</select>
			 /
			<input name="no_skhun" type="text" value="'.$y_no_sttb.'" size="10">
			</td>
			</tr>
